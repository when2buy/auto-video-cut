...
|------|-------|-----|---------|
| 2026-05-30 | **v0.4 SEMANTIC REMIX** ⭐ | https://reports.steveouyang.com/2026-05-30-v0.4-remix-demo | Template-driven non-chronological reordering. 2 fixtures × 3 templates (viral_hook / top3 / thesis) = 6 remixes. Gemini classifies sentences by role then assembles per template. |
...
- Use `eval/publish_all.sh` to deploy: bundles all reports + assets/{v0.3,v0.4}/ in one wrangler call
